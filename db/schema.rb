...
ActiveRecord::Schema.define(version: 20141025213444) do
  ...
  add_index "enrollments", ["lecture_id"], name: "index_enrollments_on_lecture_id", using: :btree
  ...
  create_table "lectures_users", id: false, force: true do |t|
